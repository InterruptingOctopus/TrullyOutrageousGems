...
public class ModCrafting {
	...
	public static void register(){
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.gem, 9, 0), new ItemStack(Item.getItemFromBlock(ModBlocks.gemBlock), 1, 0));
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.gem, 9, 1), new ItemStack(Item.getItemFromBlock(ModBlocks.gemBlock), 1, 1));
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.gem, 9, 2), new ItemStack(Item.getItemFromBlock(ModBlocks.gemBlock), 1, 2));
		//benches
